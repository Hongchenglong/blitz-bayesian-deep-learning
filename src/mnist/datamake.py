...
def csv_to_in(csv_path):
    """
    将mnist_test.csv中的测试点转换为mnist_{}_local_property.in文件
    mnist_{}_local_property.in对应着某张图片的像素点
    """
    index = 0
    with open(csv_path, 'r') as csv_file:
        ...
        for data in datas:
            ...
            with open("./mnist_{}_local_property.in".format(index), "w") as single_file:
                for i in range(28):
                    for j in range(28):
